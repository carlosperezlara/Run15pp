...
if(isEXgood) {
  if(isBBgood) {
    ...
    hEVC[0][ 6]->Fill( q2ex[1].Psi2Pi(), q2bb[2].Psi2Pi() );
    hEVC[0][ 7]->Fill( q2ex[2].Psi2Pi(), q2bb[2].Psi2Pi() );
    hEVC[0][ 8]->Fill( q2ex[3].Psi2Pi(), q2bb[2].Psi2Pi() );
    hEVC[0][ 9]->Fill( q2ex[4].Psi2Pi(), q2bb[2].Psi2Pi() );
    hEVC[0][10]->Fill( q2ex[5].Psi2Pi(), q2bb[2].Psi2Pi() );
    hEVC[0][11]->Fill( q2ex[6].Psi2Pi(), q2bb[2].Psi2Pi() );
    hEVC[0][12]->Fill( q2ex[7].Psi2Pi(), q2bb[2].Psi2Pi() );
    //hEVC[0][13]->Fill( q2ex[8].Psi2Pi(), q2bb[2].Psi2Pi() );
  }
  if(isFVgood) {
    hEVC[0][14]->Fill( q2ex[0].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][15]->Fill( q2ex[1].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][16]->Fill( q2ex[2].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][17]->Fill( q2ex[3].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][18]->Fill( q2ex[4].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][19]->Fill( q2ex[5].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][20]->Fill( q2ex[6].Psi2Pi(), q2fv[0].Psi2Pi() );
    hEVC[0][21]->Fill( q2ex[7].Psi2Pi(), q2fv[0].Psi2Pi() );
    //hEVC[0][22]->Fill( q2ex[8].Psi2Pi(), q2fv[0].Psi2Pi() );
  }
  if(isCAgood) {
    hEVC[0][23]->Fill( q2ex[0].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][24]->Fill( q2ex[1].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][25]->Fill( q2ex[2].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][26]->Fill( q2ex[3].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][27]->Fill( q2ex[4].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][28]->Fill( q2ex[5].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][29]->Fill( q2ex[6].Psi2Pi(), q2ca[0].Psi2Pi() );
    hEVC[0][30]->Fill( q2ex[7].Psi2Pi(), q2ca[0].Psi2Pi() );
    //hEVC[0][31]->Fill( q2ex[8].Psi2Pi(), q2ca[0].Psi2Pi() );
  }
 }
if(isCAgood) {
  if(isBBgood) {
    hEVC[0][32]->Fill( q2ca[0].Psi2Pi(), q2bb[2].Psi2Pi() );
  }
 }
